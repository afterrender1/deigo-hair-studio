...
export default function Navbar() {
  ...
  return (
    <header className="fixed top-0 w-full z-50 backdrop-blur-md border-white/30 bg-sky-100">
      <nav className="max-w-7xl mx-auto px-6 lg:px-10">
        ...
        {/* Mobile Menu Panel */}
        {open && (
          <div className="md:hidden mt-3 bg-white/40 backdrop-blur-md rounded-xl shadow-lg p-4 flex flex-col gap-4">
