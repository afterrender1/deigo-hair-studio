...
export default function Navbar() {
  ...
  const CTAButton = (
    <a href="#contact" className="w-full sm:w-auto">
      <button className="relative inline-flex items-center justify-center px-4 sm:px-6 md:px-2 py-2 sm:py-2.5 md:py-3 lg:py-2.5 overflow-hidden tracking-tighter text-xs sm:text-sm md:text-sm lg:text-base xl:text-lg text-white bg-sky-500 rounded-md group w-full sm:w-auto">
