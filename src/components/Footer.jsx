  ...
  return (
    ...
    <footer className="footer p-10 text-sky-900 flex flex-col md:flex-row justify-around items-center">
      ...
      <nav className="text-center md:text-left mb-6 md:mb-0">
        <h6 className="footer-title font-bold mb-3">Services</h6>
      ...
      {/* Company */}
      <nav className="text-center md:text-left mb-6 md:mb-0">
        <h6 className="footer-title font-bold mb-3">Company</h6>
        <ul className="space-y-2">
      ...
      <nav className="text-center md:text-left">
        <h6 className="footer-title font-bold mb-3">Social</h6>
