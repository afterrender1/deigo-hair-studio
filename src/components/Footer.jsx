...
export default function Footer() {
  ...
  return (
    <>
      <footer className="footer p-6 xs:p-8 sm:p-10 bg-sky-50 text-sky-900 flex flex-row md:flex-row justify-around items-start md:items-center gap-6 xs:gap-8 sm:gap-12  backdrop-blur-md">
        {/* Services */}
